      ...
      <section className="relative py-24 lg:py-32 overflow-hidden">
          ...
          <div className="mx-auto max-w-4xl text-center">
            <div className="animate-fade-in-up">
              ...
              <h1 className="text-4xl font-bold tracking-tight text-balance sm:text-6xl lg:text-7xl">
                SwastAI – Your <span className="gradient-text">AI Health Assistant</span>
              </h1>
            </div>
        ...
        <div className="mt-16 sm:mt-24">
          <div className="container mx-auto px-6 max-w-6xl">
            <div
              className="animate-fade-in-up relative rounded-xl bg-muted/50 p-2 ring-1 ring-inset ring-border lg:rounded-2xl lg:p-4 card-hover mx-auto max-w-5xl"
              style={{ animationDelay: "0.6s" }}
            >
              <img
                src="/modern-ai-health-dashboard-interface-with-medical-.jpg"
                alt="SwastAI Dashboard"
                className="rounded-md shadow-2xl ring-1 ring-border w-full h-auto mx-auto"
              />
            </div>
          </div>
        </div>
          ...
          <div className="mx-auto max-w-2xl lg:max-w-none">
            ...
            <dl className="mt-16 grid grid-cols-1 gap-6 overflow-hidden text-center sm:grid-cols-2 lg:grid-cols-4">
              ...
              >
                ...
                <dd className="text-3xl font-semibold tracking-tight text-secondary flex items-center justify-center gap-2">
              ...
              >
                ...
                <dd className="text-3xl font-semibold tracking-tight text-accent flex items-center justify-center gap-2">
      ...
      <section className="py-24 sm:py-32">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="mx-auto max-w-2xl text-center animate-fade-in-up">
            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl text-balance">Why Choose SwastAI?</h2>
            <p className="mt-4 text-lg leading-8 text-muted-foreground">
        ...
        <div className="container mx-auto py-8 px-6 max-w-7xl">
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-semibold gradient-text">SwastAI</span>
            </div>
            <p className="text-sm text-muted-foreground">
              © 2025 SwastAI. A competition project for healthcare innovation.
            </p>
          </div>
        </div>
      </footer>
